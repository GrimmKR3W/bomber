...
# Email details
recipient_email = "mloki77@yahoo.com"
subject = "Rapid Email Test"
message_body = "This is a test email sent using Python in rapid succession."
...
num_emails_to_send = 5  # Number of emails to send
